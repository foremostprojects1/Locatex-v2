...
/** Left navigation of the dashboard pages. */
export default function DashboardSidebar() {
  const { pathname } = useLocation();
  const itemClass = (to) => `nav-menu-item${pathname === to ? " active" : ""}`;
    ...
    <div className="sidebar-menu-dashboard">
      ...
      <div className="user-box">
        ...
        <div className="user">
          ...
          <div className="content">
            ...
            <div className="text-white fw-6">support@locatex.in</div>
          </div>
        </div>
      </div>
      <div className="menu-box">
        ...
        <ul className="box-menu-dashboard">
          ...
          <li className={itemClass("/my-profile")}>
            <Link className="nav-menu-link" to="/my-profile">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
          ...
          <li className={itemClass("/reviews")}>
          ...
          <li className={itemClass("/my-property")}>
            <Link className="nav-menu-link" to="/my-property">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
          ...
          <li className={itemClass("/my-favorites")}>
            <Link className="nav-menu-link" to="/my-favorites">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
          ...
          <li className={itemClass("/message")}>
            <Link className="nav-menu-link" to="/message">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
              ...
              >
                <g opacity="0.2">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M17.4808 17.4814C14.6793 20.2831 10.531 20.8885 7.13625 19.3185C6.6351 19.1167 6.22423 18.9537 5.83362 18.9537C4.74565 18.9601 3.39143 20.015 2.68761 19.3121C1.98379 18.6082 3.03952 17.2529 3.03952 16.1583C3.03952 15.7677 2.88291 15.3641 2.68116 14.862C1.11046 11.4678 1.71663 7.31811 4.5181 4.51726C8.09433 0.939714 13.9045 0.939714 17.4808 4.51634C21.0635 8.09941 21.057 13.9047 17.4808 17.4814Z"
                    stroke="#F1FAEE"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <li className={itemClass("/add-property")}>
            <Link className="nav-menu-link" to="/add-property">
              <svg
                width="22"
                height="22"
                viewBox="0 0 24 24"
