...
export default function HomeV4() {
  return (
    <>
              ...
              <div className="tab-pane" id="viewAll" role="tabpanel">
                ...
                <div className="row">
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    {" "}
                    <PropertyCard property={PROPERTIES[24]} />{" "}
                  </div>{" "}
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    {" "}
                    <PropertyCard property={PROPERTIES[25]} />{" "}
                  </div>{" "}
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    {" "}
                    <PropertyCard property={PROPERTIES[26]} />{" "}
                  </div>{" "}
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    {" "}
                    <PropertyCard property={PROPERTIES[27]} />{" "}
                  </div>{" "}
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    {" "}
                    <PropertyCard property={PROPERTIES[28]} />{" "}
                  </div>{" "}
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    {" "}
        ...
        <div className="flat-img-with-text style-2">
          ...
          <div className="content-left position-relative">
            ...
            <div className="img-wrap img-animation wow">
              {" "}
              <img src="/images/banner/img-w-text3.jpg" alt="" />{" "}
            </div>{" "}
            <div className="box-count">
              ...
              <div className="count-item ani5">
                ...
                <div className="avatar avt-56 avt-status">
                  {" "}
                  <img src="/images/avatar/avt-png7.png" alt="avt" />{" "}
              ...
              <div className="count-item ani4">
                ...
                <div className="avatar avt-56">
                  {" "}
                  <img src="/images/avatar/avt-png8.png" alt="avt" />{" "}
                </div>{" "}
                <div className="content">
                  {" "}
                  <div className="tf-counter">
      ...
      <section className="flat-section flat-location px-10">
        {" "}
        <div className="box-title text-center wow fadeInUp">
          {" "}
      ...
      <section className="mx-10 flat-section bg-primary-new radius-30">
        ...
        <div className="flat-img-with-text style-2">
          ...
          <div className="content-left img-animation wow">
            {" "}
            <img src="/images/banner/img-w-text4.jpg" alt="" />{" "}
          </div>{" "}
          <div className="content-right">
            {" "}
            <div className="box-title wow fadeInUp">
      ...
      <section className="mx-5 bg-primary-new radius-30">
        ...
        <div className="flat-img-with-text">
          ...
          <div className="content-left img-animation wow">
            {" "}
            <img src="/images/banner/img-w-text1.jpg" alt="" />{" "}
          </div>{" "}
          <div className="content-right">
            {" "}
            <div className="box-title wow fadeInUp">
