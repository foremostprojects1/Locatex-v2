        ...
        >
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              {" "}
              <a
                href="/images/slider/baner-single-1.jpg"
            ...
            <div className="swiper-slide">
              {" "}
              <a
                href="/images/slider/baner-single-2.jpg"
                data-fancybox="gallery"
                className="box-img-detail d-block"
              >
                {" "}
          ...
          <div className="row">
            ...
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="single-property-element">
                ...
                <div className="single-property-desc">
                  ...
                  <p className="text-variant-1">
                    Located around an hour away from Paris, between the Perche
                    and the Iton valley, in a beautiful wooded park bordered by
                    a charming stream, this country property immediately seduces
                    with its bucolic and soothing environment.
                  </p>{" "}
                  <p className="mt-8 text-variant-1">
                    An ideal choice for sports and leisure enthusiasts who will
                    be able to take advantage of its swimming pool (11m x 5m),
              ...
              <div className="single-property-element single-property-loan">
                {" "}
                <h6 className="title fw-6">Loan Calculator</h6>{" "}
