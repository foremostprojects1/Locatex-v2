...
export default function Contact() {
  return (
    <>
                ...
                <ul>
                  <li className="box">
                    ...
                    <p className="text-variant-1">
                      101 E 129th St, East Chicago, IN 46312 <br /> United
                      States
                    </p>{" "}
                  </li>
                  <li className="box">
                    ...
                    <p className="text-variant-1">
                      1-333-345-6868 <br /> hi.support@locatex.in
                    </p>{" "}
                  </li>
                  <li className="box">
                    {" "}
                    ...
                    <p className="text-variant-1">
                      Monay - Friday: 08:00 - 20:00 <br /> Saturday - Sunday:
                      10:00 - 18:00
                    </p>{" "}
                  </li>
                  <li className="box">
      ...
      <section className="">
        {" "}
        <PropertyMap id="map-contact" className="map-contact" zoom={16} />{" "}
      </section>{" "}
